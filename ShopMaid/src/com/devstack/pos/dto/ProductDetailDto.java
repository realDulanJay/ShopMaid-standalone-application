...
public class ProductDetailDto {
    ...
    public ProductDetailDto(String code, String barcode, int qtyOnHand, double sellingPrice, double showPrice, double buyingPrice, int productCode, boolean discountAvailability) {
        this.code = code;
